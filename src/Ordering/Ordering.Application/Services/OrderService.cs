...
//        {
//            var mappedEntity = OrderMapper.Mapper.Map<Order>(orderModel);
//            if (mappedEntity == null)
//                throw new ApplicationException($"Entity could not be mapped.");

//            var newEntity = await _orderRepository.AddAsync(mappedEntity);

//            var newMappedEntity = OrderMapper.Mapper.Map<OrderModel>(newEntity);
...
//            var mapped = OrderMapper.Mapper.Map<IEnumerable<OrderModel>>(orderList);
//            return mapped;            
//        }
//    }
//}
